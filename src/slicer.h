...
protected:
     ...
     */
    void makeBasicPolygonLoops(Polygons& open_polylines, Polygon& open_digon, int layer_num);
     ...
     */
    void makeBasicPolygonLoop(Polygons& open_polylines, Polygon& open_digon, unsigned int start_segment_idx, int layer_num);
